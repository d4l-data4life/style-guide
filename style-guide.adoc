...
((:heavy_check_mark:)) icon:eye[] See <<Writing-link-text-web-addresses-and-URLs>>

((:heavy_check_mark:)) icon:external-link[] See https://www.w3.org/WAI/standards-guidelines/wcag/
...
((:heavy_check_mark:)) To show your password, in the *Login* dialog, in the *Password* field, choose the icon:eye[]  Eye symbol.
