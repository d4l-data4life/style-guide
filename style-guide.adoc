...
((:lock:)) Lock for maximum security

((:question:)) Red question mark icon

((:eye:)) Key

((:copyright:)) Copyright sign

((:envelope:) For email address {email-docs}
...
Should you have any such feedback, talk to your technical writer or send an email to ((:envelope:)) {email-docs}.
